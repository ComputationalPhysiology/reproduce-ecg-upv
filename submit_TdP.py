...
$CONDA_PREFIX/bin/mpirun -n {ntasks} $CONDA_PREFIX/bin/python ${{ROOT}}/main_fenicsx.py run -d ${{ROOT}}/hex-mesh -o ${{SCRATCH_DIRECTORY}} --sex {sex} --case {case} --single-cell-ourdir ${{SINGLE_CELL_OURDIR}}
